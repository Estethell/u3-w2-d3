...
class ThirdMovies extends Component {
  state = {
    arrayOfMovies: [],
    loader: true,
  };
  ...
  fetchMovies = () => {
    const url = "  http://www.omdbapi.com/?i=tt3896198&apikey=e8901073&s=fantozzi";
    fetch(url)
      .then((response) => {
        if (response.ok) {
  ...
  render() {
    return (
      <div>
        <h4 className="m-5">Ti piace Fan</h4>
